<template>
  <section class="py-16 px-10 bg-gray-50">
    <div class="container-primary">
      ...
      <div class="grid md:grid-cols-2 gap-8 items-center bg-white shadow-md rounded-2xl overflow-hidden">
        <!-- Map -->
        <div class="h-full w-full">
          <iframe
            title="Map"
            src="https://www.openstreetmap.org/export/embed.html?bbox=-0.257%2C5.556%2C-0.142%2C5.635&layer=mapnik"
        ...
        <!-- Contact Info -->
        <div class="p-8">
          <h3 class="text-2xl font-semibold mb-6">Visit Us</h3>
          ...
          <div class="flex items-start gap-4 mb-6">
            ...
            <div>
              <p class="font-medium">Our Contact Number</p>
              <a href="tel:+233244236578" class="text-gray-600">+233 (0) 244 236 578</a>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4 mb-6">
            ...
            <div>
              <p class="font-medium">Our Contact E-mail</p>
              <a href="mailto:info@bereanoblefoundation.com" class="text-gray-600">info@bereanoblefoundation.com</a>
            </div>
          </div>

          <!-- Social Icons -->
          <div>
            <p class="font-medium mb-3">Stay Connected</p>
...
// No props needed for now, but we can make address/phone/email/socials dynamic later.
</script>
