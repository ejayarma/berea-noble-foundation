            ...
            <div class="container-primary">
                <div class="flex justify-between gap-10 px-10">
                    <div class="w-1/3">
                        ...
                        <p class="mb-10 text-prose text-background">Empowering communities through education, healthcare, and support services. Building bridges
                            to knowledge and fostering hope in underserved areas.</p>
                        <h4 class="footer-title mb-4">Stay Connected</h4>
                        <div class="inline-flex gap-4">
                            <a class="hover:text-brand transition-colors duration-300" href="#">
                                <!-- Facebook -->
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><!-- Icon from MingCute Icon by MingCute Design - https://github.com/Richard9394/MingCute/blob/main/LICENSE --><g fill="none" fill-rule="evenodd"><path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"/><path fill="currentColor" d="M4 12a8 8 0 1 1 9 7.938V14h2a1 1 0 1 0 0-2h-2v-2a1 1 0 0 1 1-1h.5a1 1 0 1 0 0-2H14a3 3 0 0 0-3 3v2H9a1 1 0 1 0 0 2h2v5.938A8 8 0 0 1 4 12m8 10c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10"/></g></svg>
                            </a>
                            <a class="hover:text-brand transition-colors duration-300" href="#">
                                <!-- Instagram -->
                    ...
                    <div class="px-10 w-1/3">
                        ...
                        <ul class="flex flex-col gap-2">
                            <li><a class="hover:text-brand transition-colors duration-300 text-lg" href="#">Home</a></li>
                            <li><a class="hover:text-brand transition-colors duration-300 text-lg" href="#">About Us</a></li>
                            <li><a class="hover:text-brand transition-colors duration-300 text-lg" href="#">Programs</a></li>
                            <li><a class="hover:text-brand transition-colors duration-300 text-lg" href="#">Gallery</a></li>
                            <li><a class="hover:text-brand transition-colors duration-300 text-lg" href="#">Blog</a></li>
                            <li><a class="hover:text-brand transition-colors duration-300 text-lg" href="#">Contact</a></li>
                        </ul>
                    </div>
                    <div class="px-10 w-1/3">
                        <h4 class="footer-title mb-2">Contact Us</h4>
                        <ul class="flex flex-col gap-4">
                            <li class="inline-flex gap-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="text-brand size-8" viewBox="0 0 24 24"><!-- Icon from MingCute Icon by MingCute Design - https://github.com/Richard9394/MingCute/blob/main/LICENSE --><g fill="none" fill-rule="evenodd"><path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"/><path fill="currentColor" d="M8.172 15.829c3.845 3.845 7.408 4.266 8.454 4.305c1.264.046 2.554-.986 3.112-2.043c-.89-1.044-2.049-1.854-3.318-2.732c-.749.748-1.672 2.138-2.901 1.64c-.699-.281-2.425-1.076-3.933-2.585S7.283 11.18 7 10.482c-.498-1.231.896-2.156 1.645-2.905c-.878-1.29-1.674-2.479-2.716-3.324c-1.072.56-2.11 1.84-2.063 3.121c.039 1.046.46 4.609 4.306 8.455m8.38 6.304c-1.44-.053-5.521-.617-9.795-4.89c-4.273-4.274-4.836-8.354-4.89-9.795c-.08-2.196 1.602-4.329 3.545-5.162a1.47 1.47 0 0 1 1.445.159c1.608 1.173 2.717 2.95 3.67 4.342A1.504 1.504 0 0 1 10.35 8.7l-1.356 1.357C9.309 10.752 9.95 11.95 11 13s2.248 1.691 2.944 2.006l1.355-1.356a1.5 1.5 0 0 1 1.918-.171c1.42.984 3.088 2.077 4.304 3.634a1.47 1.47 0 0 1 .189 1.485c-.837 1.953-2.955 3.616-5.158 3.535"/></g></svg>
                                <a class="inline-block hover:text-brand transition-colors duration-300 text-lg" href="tel:+233244236578">+233 (0) 244 236 578</a>
                            </li>
                            <li class="inline-flex gap-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="text-brand size-8" viewBox="0 0 24 24"><!-- Icon from MingCute Icon by MingCute Design - https://github.com/Richard9394/MingCute/blob/main/LICENSE --><g fill="none"><path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"/><path fill="currentColor" d="M20 4a2 2 0 0 1 1.995 1.85L22 6v12a2 2 0 0 1-1.85 1.995L20 20H4a2 2 0 0 1-1.995-1.85L2 18V6a2 2 0 0 1 1.85-1.995L4 4zm0 3.414l-6.94 6.94a1.5 1.5 0 0 1-2.12 0L4 7.414V18h16zM18.586 6H5.414L12 12.586z"/></g></svg>
                                <a class="inline-block hover:text-brand transition-colors duration-300 text-lg" href="mailto:info@bereanoblefoundation.com">@info@bereafoundation.com</a>
                            </li>
                            <li class="inline-flex gap-4">
                                ...
                                <a class="inline-block hover:text-brand transition-colors duration-300 text-lg" href="#">201, Avenue of the Stars <br> Airport Hills, Accra </a>
                            </li>
                        </ul>
                    </div>
                </div>
            </div>
            <hr class="mb-4 mt-10 border-0 h-px bg-background/50">
            <div class="container-primary">
                <p class="text-lg text-brand text-center">© 2024 Berea Noble Foundation. All rights reserved.</p>
            </div>
        </div>
